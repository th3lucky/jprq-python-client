 ...
 * created by Nuitka version 0.6.17.2
 *
...
static PyCodeObject *codeobj_47438929e207ff13f25cf7c1e4f576d7;
/* For use in "MainProgram.c". */
PyCodeObject *codeobj_main = NULL;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[8]); CHECK_OBJECT(module_filename_obj);
    codeobj_47438929e207ff13f25cf7c1e4f576d7 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[9], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_47438929e207ff13f25cf7c1e4f576d7;
    ...
    // Module code.
    // Frame without reuse.
    frame_47438929e207ff13f25cf7c1e4f576d7 = MAKE_MODULE_FRAME(codeobj_47438929e207ff13f25cf7c1e4f576d7, module___main__);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_47438929e207ff13f25cf7c1e4f576d7);
    assert(Py_REFCNT(frame_47438929e207ff13f25cf7c1e4f576d7) == 2);

    // Framed code:
    {
        PyObject *tmp_imported_value_1;
        frame_47438929e207ff13f25cf7c1e4f576d7->m_frame.f_lineno = 1;
    ...
    }
    {
        ...
        frame_47438929e207ff13f25cf7c1e4f576d7->m_frame.f_lineno = 5;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_47438929e207ff13f25cf7c1e4f576d7);
#endif
    popFrameStack();

    assertFrameObject(frame_47438929e207ff13f25cf7c1e4f576d7);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_47438929e207ff13f25cf7c1e4f576d7, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_47438929e207ff13f25cf7c1e4f576d7->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_47438929e207ff13f25cf7c1e4f576d7, exception_lineno);
    }
